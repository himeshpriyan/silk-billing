...
import WeddingLookbook from "./pages/WeddingLookbook";
import AIBusinessSuite from "./pages/AIBusinessSuite";
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/wedding-lookbook" element={<WeddingLookbook />} />
        <Route path="/ai-business-suite" element={<AIBusinessSuite />} />
