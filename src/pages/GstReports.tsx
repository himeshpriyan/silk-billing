...
const GstReports: React.FC = () => {
    ...
    const fetchGstData = async () => {
        try {
            ...
            const mockGstData: GstData = {
                totalTaxable: 1250000,
                totalTax: 62500,
                b2bCount: 12,
                hsnSummary: [
                    { code: '5007', description: 'Woven fabrics of silk', taxable: 850000, tax: 42500, rate: 5 },
                    { code: '5208', description: 'Woven fabrics of cotton', taxable: 250000, tax: 12500, rate: 5 },
                    { code: '5407', description: 'Woven fabrics of synthetic', taxable: 150000, tax: 7500, rate: 5 }
                ]
            };
